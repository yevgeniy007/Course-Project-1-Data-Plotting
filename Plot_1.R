...
## Most frequeNt observations corresponds to low values of power per minute, probably corresponding to lightig  (we cannot tell this from data but can explore further)
...
## if we produce this histogram with a higher resolution (Histogram-(scenario)-higher resolution.png), we can see clearly a discrete pattern of power consumption 
